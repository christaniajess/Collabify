...
# "mysql+mysqlconnector://blacklist_handler@localhost:3306/blacklist"
app.config['SQLALCHEMY_DATABASE_URI'] = os.environ.get("dbURL")
# app.config['SQLALCHEMY_DATABASE_URI'] = "mysql+mysqlconnector://blacklist_handler@localhost:3306/blacklist"
